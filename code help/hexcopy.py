...
# check the ida version
    # if the version is 6.9
    # major, minor = 6, 9
major, minor = map(int, idaapi.get_kernel_version().split("."))
using_ida7api = (major > 6) # if he use version 7
using_pyqt5 = using_ida7api or (major == 6 and minor >= 9) # or version 6.9

# another shitty imports
if using_pyqt5:
...
# the main program functionality
def copy_bytes_py2():
    """
